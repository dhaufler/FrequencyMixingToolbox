function [R1,R2,Ramp,R_inds,median_R1_,median_R2_] = get_possible_R1_R2_from_set3(X,Y,RelType,Centroid_mag, TripletTable,max_distance,min_clu_N,N_iterations)
%INPUT:
